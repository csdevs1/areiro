            ...
            <header>
                <div id="top-nav" class="top-nav">
                    <div class="wrapper">
                        ...
                        <nav class="nav">
                            <ul>
                                <a href="index.html.erb"><li><i class="fa fa-home"></i> Home</li></a>
                ...
                <section>
                    <div class="wrapper">
                        <div id="pattern" class="pattern">
                            <ul class="g">
                                <li><a href="product.php"><img src="http://bradfrost.github.com/this-is-responsive/patterns/images/fpo_square.png" alt="Product Name" /></a><a href="product.html">Product</a><p>Product description here djkndslkvndslkvnvnjnjvnkvklmmv  klmvmklcv klmcvkmcv kmcvklmcvkmlvc</p><p>Price: 999</p></li>
                                <li><a href="product.html"><img src="http://bradfrost.github.com/this-is-responsive/patterns/images/fpo_square.png" alt="Product Name" /></a></li>
